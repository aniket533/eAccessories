<div class="container-fluid fixed-top" style="top: 0px;">
		...
		<div class="d-flex justify-content-between">
			<div class="top-info ps-2">
				<small class="me-3"><i
					...
					class="text-white">Navarangpura, Ahmedabad</a></small> <small class="me-3"><i
					class="fas fa-envelope me-2 text-secondary"></i><a href="#"
					class="text-white">kk4766670@gmail.com</a></small>
			</div>
	...
	<div class="container px-0">
		<nav class="navbar navbar-light bg-white navbar-expand-xl">
			<a href="userhome" class="navbar-brand"><h1
					class="text-primary display-6">Gadgets Marketplace</h1></a>
			...
			<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
				<div class="navbar-nav mx-auto">
					<a href="userhome" class="nav-item nav-link active">Home</a> <a
						href="userhome#accessoriesshop" class="nav-item nav-link">Shop</a>
					<!--<a href="shop-detail.html" class="nav-item nav-link">Shop
						Detail</a>
						-->
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu m-0 bg-secondary rounded-0">
							<a href="listusercart" class="dropdown-item">Cart</a> 
							
							<!-- <a
								href="chackout.html" class="dropdown-item">Chackout</a> 
				...
				<div class="d-flex m-3 me-0">
					...
					<a href="listusercart" class="position-relative me-4 my-auto">
